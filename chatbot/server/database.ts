...
export type LeadRecord = {
  ...
  googleSheetsStatus: "pending" | "sent" | "failed";
...
function mapLead(row: DatabaseRow): LeadRecord {
  return {
    ...
    googleSheetsStatus: row.google_sheets_status as LeadRecord["googleSheetsStatus"],
...
type DeliveryColumn = "google_sheets_status" | "client_email_status" | "team_email_status";
const deliveryColumns: Record<string, DeliveryColumn> = { googleSheets: "google_sheets_status", clientEmail: "client_email_status", teamEmail: "team_email_status" };
